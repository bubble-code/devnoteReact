...
function BarAddChoose({ listCMs, title, handleChange, addOpen, currentCM, ...rest }) {
    return (
        <SoftBox px={2} py={2} display="flex" justifyContent="start" alignItems="center" borderRadius="md"  >
            ...
            <SoftButton sx={{ border: 'none' }} bgColor='transparent' ><SoftTypography variant='caption' onClick={() => addOpen()}>Add Client</SoftTypography></SoftButton>
        </SoftBox>
    )

}

export default BarAddChoose;

BarAddChoose.propTypes = {
